...
protected
  ...
  def infowindow_for_event(event)
    "<div style=\"font-size: 1.1em; font-weight: bold;\">" + 
      "<a href=\"#{request.protocol}#{request.host_with_port}/events/show/#{event.id}\">#{event.title}</a></div>" +
  ...
  def infowindow_for_jam(jam)
    "<div style=\"font-size: 1.1em; font-weight: bold;\">" + 
      "<a href=\"#{request.protocol}#{request.host_with_port}/jams/show/#{jam.id}\">#{jam.title}</a></div>" +
  ...
  def infowindow_for_organization(organization)
    "<div style=\"font-size: 1.1em; font-weight: bold;\">" + 
      "<a href=\"#{request.protocol}#{request.host_with_port}/organizations/show/#{organization.id}\">#{organization.title}</a></div>" +
  ...
  def infowindow_for_person(person)
    "<div style=\"font-size: 1.1em; font-weight: bold;\">" + 
      "<a href=\"#{request.protocol}#{request.host_with_port}/people/show/#{person.id}\">#{person.title}</a></div>" +
